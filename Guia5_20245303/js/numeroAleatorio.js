...
// Creemos una constante que permite identificar el maximo  de <intentos></intentos>
...
function generarNumeroAleatorio() {
	...
	if ( numero < numeroAleatorio ) { mensaje = `El numero que esta buscando es mas alto`; }
	else if ( numero > numeroAleatorio ) { mensaje = `El numero que esta buscando es mas bajo`; }

	// Aumentamos el valor de los intentos
	intentos++;
	} else {
		mensaje = `Su numero de intentos ha terminado. El numero oculto era: ${numeroAleatorio}.
		Refresque la pagina para volver a jugar.`;
	}
